					...
					<div class="col s4">
						<div class="card green center-align">
							<div class="card-content white-text">
								<span class="card-title">Server Status</span><div class="error" style="width: 15px;height: 15px;background-color: #ef4836;border-radius: 50px;display: inline-block;margin-left: 15px;"></div>
...
<div class="col s4">
						<div class="card green center-align">
							<div class="card-content white-text">
								<span class="card-title">Bot Status</span><div class="error" style="width: 15px;height: 15px;background-color: #ef4836;border-radius: 50px;display: inline-block;margin-left: 15px;"></div>
